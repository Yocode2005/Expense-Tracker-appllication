...
import { ArrowDown, BarChart2, ChevronDown,TrendingUp as ProfitIcon,PieChart as PieChartIcon, ChevronUp, DollarSign, PiggyBank, Plus, ShoppingCart, TrendingDown, TrendingUp, Wallet, PieChart } from "lucide-react";
...
const Dashboard = () => {
  ...
  const displayedExpense = showAllExpense
    ...
    : expenseListForDisplay.slice(0, 3); // show 3 then a toggle button
