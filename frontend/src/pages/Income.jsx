...
const API_BASE = "https://expense-tracker-appllication.onrender.com/api"; // base URL for API calls
...
const Income = () => {
  ...
  // to get the token from localstorage for user verification
  ...
  const incomeTransactions = useMemo(
    ...
    [outletTransactions],
  ); // filter transactions comming from outletcontext
  ...
  const handleExport = useCallback(async () => {
    try {
      const res = await axios.get(`${API_BASE}/incomes/downloadexcel`, {
        headers: getAuthHeaders(),
        responseType: "blob",
      });
